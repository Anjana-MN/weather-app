...
public class CommonUtils {
     ...
     */
    @Cacheable(value = "WeatherData", cacheManager = "cacheManager", key = "'city='+#inputParam.get('city')+'&units='+#inputParam.get('units')+'&count='+#inputParam.get('count')", condition = "#weatherDataList != null && #weatherDataList.weatherForecastedDataList != null && #weatherDataList.weatherForecastedDataList.size() != 0")
