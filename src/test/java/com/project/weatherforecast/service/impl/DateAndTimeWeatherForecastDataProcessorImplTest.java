...
public class DateAndTimeWeatherForecastDataProcessorImplTest {
    ...
    public void testFetchTimelyForecast() throws IOException {
        ...
        assertNotNull(weatherService.getWeatherData("timely",inputParam));
    }
    ...
    public void testFetchCurrentWeather() throws IOException {
        ...
        when(weatherUtils.processWeatherResponse(Mockito.any(),Mockito.any())).thenReturn(weatherData);
        when(weatherUtils.fetchDay(anyString(),anyInt())).thenReturn("MONDAY");
        inputParam.put(Constants.UNITS,"celsius");
        assertNotNull(weatherService.getWeatherData("current",inputParam));
    }
    ...
    public void testFetchDailyForecast() throws IOException {
        ...
        inputParam.put(Constants.UNITS,"celsius");
        assertNotNull(weatherService.getWeatherData("daily",inputParam));
    }
    ...
    public void testFetchThreeDayForecast() throws IOException {
        ...
        when(weatherUtils.fetchWeatherIcon(any(),anyInt())).thenReturn("04n");
        inputParam.put(Constants.UNITS,"celsius");
        assertNotNull(weatherService.getWeatherData("threeDay",inputParam));
    }
}
